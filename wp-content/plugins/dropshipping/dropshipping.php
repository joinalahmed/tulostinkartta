<?php
  /*
    Plugin Name: Dropshipping
    Plugin URI: http://sange.fi/
    Description: Check stock status of a dropshipping company's products in WooCommerce when there is no proper API
    Version: 1.0
    Author: Tomi Toivio
...
/* Get Dropshipping meta values for WooCommerce products */
...
/* Add Dropshipping meta box in WooCommerce product admin */
...
/* HTML for Dropshipping meta box */
...
function dropshipping_html( $post) {
    ...
    <p>Leave empty if not a dropshipping product.</p><p>
    <label for="dropshipping_dropshipping_url"><?php _e( 'Dropshipping URL', 'dropshipping' ); ?></label><br>
    <input type="text" name="dropshipping_dropshipping_url" id="dropshipping_dropshipping_url" value="<?php echo dropshipping_get_meta( 'dropshipping_dropshipping_url' ); ?>"></p><p><label for="dropshipping_out_of_stock_text"><?php _e( 'Out Of Stock Text', 'dropshipping' ); ?></label><br><input type="text" name="dropshipping_out_of_stock_text" id="dropshipping_out_of_stock_text" value="<?php echo dropshipping_get_meta( 'dropshipping_out_of_stock_text' ); ?>"></p>
    <p><label for="dropshipping_in_stock_text"><?php _e( 'In Stock Text', 'dropshipping' ); ?></label><br><input type="text" name="dropshipping_in_stock_text" id="dropshipping_in_stock_text" value="<?php echo dropshipping_get_meta( 'dropshipping_in_stock_text' ); ?>"></p>
                                <?php }

/* Save Dropshipping meta values when WooCommerce product is saved */
...
/* Check Dropshipping stock availability from the web page of the product on the dropshipping company's website */

function dropshipping_check_stock() {
    global $post, $woocommerce, $product, $woocommerce_loop, $wpdb;

/* Get array of WooCommerce products */
...
/* Make the dropshipping stock status checks run hourly */
...
/* Empty dropshipping admin page as a placeholder */
